...
export const List = ({ endpoint, onCardClick }) => {
  ...
  const handleButtonClick = (suit, number) => {
    setSelectedSuit(suit);
    setSelectedNumber(number);
    onCardClick(selectedSuit, selectedNumber)
  }
    ...
    <div className="list-container">
      {list.map((item) => (
        <div className="list-item">
          ...
          <button type="button" onClick={() => handleButtonClick(item.suit, item.number)}>
